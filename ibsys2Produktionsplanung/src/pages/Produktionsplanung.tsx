                    ...
                    <tbody>
                        {(['p1', 'p2', 'p3'] as const).map((key, index) => (
                            <tr key={key}>
                                ...
                                <td>
                                    <div style={{ width: '150px', margin: '0 auto', padding: '6px 0', backgroundColor: '#f8f9fa', border: '1px solid #ced4da', borderRadius: '4px', textAlign: 'center' }}>
                                        {forecast[key]}
                                    </div>
                                </td>
                                {[0, 1, 2].map((i) => (
                                        ...
                                        <td key={i}>
                                            <Form.Group className="text-center">
                                                <Form.Control
                                                    ...
                                                    style={{ width: '150px', margin: '0 auto', textAlign: 'center' }}
                                                />
                                                <div style={{ fontSize: '0.9em', color: restbestaende[i] < 0 ? 'red' : 'black', fontWeight: 'bold', marginTop: '4px' }}>
