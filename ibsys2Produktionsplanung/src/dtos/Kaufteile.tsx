...
export const Kaufteile: Kaufteil[] =
[
    new Kaufteil(21, 9, 2, 1, 0, 0, 300, 5, 50),
    new Kaufteil(22, 8.5, 2, 0, 1, 0, 300, 6.5, 50),
    new Kaufteil(23, 6, 1, 0, 0, 1, 300, 6.5, 50),
    new Kaufteil(24, 16, 1.5, 7, 7, 7, 6100, 0.06, 100),
    new Kaufteil(25, 4.5, 1, 4, 4, 4, 3600, 0.06, 50),
    new Kaufteil(27, 4.5, 1, 2, 2, 2, 1800, 0.1, 75),
    new Kaufteil(28, 8.5, 2, 4, 5, 6, 4500, 1.2, 50),
    new Kaufteil(32, 10.5, 2.5, 3, 3, 3, 2700, 0.75, 50),
    new Kaufteil(33, 9.5, 2.5, 0, 0, 2, 900, 22, 75),
    new Kaufteil(34, 8, 1.5, 0, 0, 72, 22000, 0.1, 50),
    new Kaufteil(35, 11, 2, 4, 4, 4, 3600, 1, 75),
    new Kaufteil(36, 6, 0.5, 1, 1, 1, 900, 8, 100),
    new Kaufteil(37, 7.5, 1.5, 1, 1, 1, 900, 1.5, 50),
    new Kaufteil(38, 8.5, 2, 1, 1, 1, 300, 1.5, 50),
    new Kaufteil(39, 7.5, 1.5, 2, 2, 2, 1800, 1.5, 75),
    new Kaufteil(40, 8.5, 1, 1, 1, 1, 900, 2.5, 50),
    new Kaufteil(41, 4.5, 1, 1, 1, 1, 900, 0.06, 50),
    new Kaufteil(42, 6, 1.5, 2, 2, 2, 1800, 0.1, 50),
    new Kaufteil(43, 10, 2.5, 1, 1, 1, 2700, 5, 75),
    new Kaufteil(44, 5, 1, 3, 3, 3, 900, 0.5, 50),
    new Kaufteil(45, 8.5, 1.5, 1, 1, 1, 900, 0.06, 50),
    new Kaufteil(46, 4.5, 1.5, 1, 1, 1, 900, 0.1, 50),
    new Kaufteil(47, 7.05, 0.5, 1, 1, 1, 900, 3.5, 50),
    new Kaufteil(48, 5, 1, 2, 2, 2, 1800, 1.5, 75),
    new Kaufteil(52, 8, 2, 2, 0, 0, 600, 22, 50),
    new Kaufteil(53, 8, 1, 72, 0, 0, 22000, 0.1, 50),
    new Kaufteil(57, 8.5, 1.5, 0, 2, 0, 600, 22, 50),
    new Kaufteil(58, 8, 2.5, 0, 72, 0, 22000, 0.1, 50),
    new Kaufteil(59, 3.5, 1, 2, 2, 2, 1800, 0.15, 50)
];
